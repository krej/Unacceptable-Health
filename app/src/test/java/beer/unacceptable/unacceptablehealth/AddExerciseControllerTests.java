...
public class AddExerciseControllerTests {
    ...
    public void emptyScreen_SaveClicked_ErrorsShown() {
        m_oController.Save("", new ArrayList<ListableObject>(), false, false, false, "", false);
    ...
    public void dataEntry_SaveClicked_SaveCalled() {
        ...
        m_oController.Save("Test", muscles, false, false, false, "123", false);
    ...
    public void emptyScreen_ErrorsShow_FixError_ErrorCleared() {
        m_oController.Save("", null, false, false, false, "", false);

        verify(view).SetNameError(anyString());

        m_oController.Save( "Test", new ArrayList<ListableObject>(), false, false, false, "", false);
